...
CKPT_PATH = "outputs-qwen2b-768/model_film_woffn_small_epoch30.pth"
...
def load_gt_dict(coco_json_path, model=None, textencoder=None):
    ...
    for ann in tqdm(coco['annotations']):
        ...
        caption = ann.get('caption','object')
        ...
        #     vis_image.save("/root/autodl-tmp/VLMs/test_results/"+file_name)
        #     a = 1
    acc = tp_counter * 1.0 / len(coco['annotations'])
...
if __name__ == "__main__":
    ...
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco_unc_val.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco_unc_testA.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco_unc_testB.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco+_unc_val.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco+_unc_testA.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcoco+_unc_testB.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcocog_umd_val.json", model, textencoder)
    load_gt_dict("/root/autodl-tmp/OOD/refcoco/annotations/refcocog_umd_test.json", model, textencoder)
